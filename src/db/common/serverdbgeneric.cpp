...
{
	boost::asio::post(*m_ioService, [this, requestId]() { m_callback.AvatarIsOK(requestId); });
}
...
void
ServerDBGeneric::SetPlayerLastGames(unsigned /*requestId*/, DB_id /*playerId*/, const std::vector<long long> &/*last_games*/, const std::string &/*playerIp*/)
{
}
