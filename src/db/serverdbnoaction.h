...
public:
	ServerDBNoAction();
	virtual ~ServerDBNoAction() noexcept override;
	...
	virtual void SetPlayerLastGames(unsigned /*requestId*/, DB_id /*playerId*/, const std::vector<long long> &/*last_games*/, const std::string &/*playerIp*/) override {}
