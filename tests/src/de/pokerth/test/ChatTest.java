...
public class ChatTest extends TestBase {
        ...
        public void testChat() throws Exception {
                ...
                // Message as registered user should be sent to other users.
                PokerTHMessage msg = createLobbyChatMsg(ChatText + 2);
                sendMessage(msg, s[0]);
                ...
                msg = receiveMessage();
                assertTrue(msg.hasChatMessage() && msg.getMessageType() == PokerTHMessageType.Type_ChatMessage);
                assertEquals(ChatText + 7, msg.getChatMessage().getChatText());
