...
public class PlayerInfoTest extends TestBase {
        ...
        public void testPlayerInfoRequest() throws Exception {
                ...
                // Request player info, for first player.
                for (int i = 0; i < 9; i++) {
                        ...
                        assertEquals(AuthUser, info.getPlayerName());
                ...
                for (int i = 0; i < 9; i++) {
                        ...
                        if (i % 2 == 0) {
                                ...
                                assertTrue(Arrays.equals(avatarHash, info.getAvatarData().getAvatarHash().toByteArray()));
                        }
                }

                // Request unknown player info.
                ...
                assertTrue(msg.hasPlayerInfoReplyMessage() && msg.getMessageType() == PokerTHMessageType.Type_PlayerInfoReplyMessage);
                PlayerInfoReplyMessage reply = msg.getPlayerInfoReplyMessage();
                assertEquals(maxPlayerId + 1, reply.getPlayerId());
