...
public class CreateRankingGameTest extends TestBase {
        ...
        private void createRankingGame(String password) throws Exception {
                ...
                NetGameInfo gameInfo = createGameInfo(NetGameType.rankingGame, 20, 7, 8, EndRaiseMode.doubleBlinds, 0, 50, AuthUser + " create ranking game " + counter, l, 10, 0, 11, 10000);
